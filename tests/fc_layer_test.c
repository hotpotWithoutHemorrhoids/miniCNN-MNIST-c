...
static float a[16] = {0.43, 0.05, -2.38,-0.75, 1.51, -0.6 ,1.37,1.09,1.11, 0.09,-1.26,0.21,0.31,0.4 , 1.13,-0.22};
static float w[16*10] = {0.43, -1.02,  0.1 , -0.7 , -0.21, -0.03,  0.43, -0.29, -1.65,
...
static float bias[10] = {-0.23,  0.22, -0.91, -0.74,  0.24, -1.2 , -0.08,  1.22, -0.37,-0.05};
static float target_out[10] = {1.4691,  2.2815, -2.6775,  0.3602, -0.9473, -1.8196,  1.6861,
    5.4752,  5.4908, -0.1792};
static float target_relu_out[10] = {1.47, 2.28, 0.00, 0.36, 0.00 ,0.00, 1.69, 5.48, 5.49, 0.00};

static float dx = {-0.0006,  0.0345, -0.0111,  0.0163, -0.0040,  0.0150,  0.0018, -0.0396,
         0.0381, -0.0098,  0.0025,  0.0305, -0.0110, -0.0178,  0.0543, -0.0377};
static float dw = {0};
